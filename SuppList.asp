...
Recordset1.Source = "SELECT *  FROM SupplierList"
...
<table border="1" cellpadding="3" cellspacing="0">
  ...
  <% While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) %>
    <tr>
      <td><a href="SuppCust.asp?Supplier=<%=(Recordset1.Fields.Item("DD_SUPPLIER_CODE").Value)%>"> <%=(Recordset1.Fields.Item("DD_SUPPLIER_CODE").Value)%> </a></td>
    </tr>
    <% 
